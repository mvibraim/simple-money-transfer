...
class RequestFingerprintTest {
  ...
  void isDeterministicForTheSameLogicalRequest() {
    String first =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "USD", "rent");
    String second =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "USD", "rent");
  ...
  void isStableAcrossIncidentalAmountScaleDifferences() {
    String scaleTwo =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "USD", null);
    String scaleFour =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.0000"), "USD", null);
    String scaleZero =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10"), "USD", null);
  ...
  void differsWhenTheAmountDiffers() {
    String ten =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "USD", null);
    String eleven =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("11.00"), "USD", null);
  ...
  void differsWhenTheCurrencyDiffers() {
    String usd =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "USD", null);
    String eur =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "EUR", null);
  ...
  void differsWhenTheKindDiffers() {
    String transfer =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "USD", null);
    String deposit =
        RequestFingerprint.of("DEPOSIT", SOURCE, TARGET, new BigDecimal("10.00"), "USD", null);
  ...
  void differsWhenTheSourceOrTargetAccountDiffers() {
    ...
    String original =
        RequestFingerprint.of("TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "USD", null);
    String differentTarget =
        RequestFingerprint.of(
            "TRANSFER", SOURCE, otherTarget, new BigDecimal("10.00"), "USD", null);
  ...
  void differsWhenTheReferenceDiffers() {
    ...
    String differentRef =
        RequestFingerprint.of(
            "TRANSFER", SOURCE, TARGET, new BigDecimal("10.00"), "USD", "invoice");
