...
class LedgerEntryRepositoryIT extends AbstractIntegrationTest {
  ...
  void repositoryExposesNoUpdateOrDeleteMethod() {
    var methodNames =
        Arrays.stream(LedgerEntryRepository.class.getMethods()).map(Method::getName).toList();
  ...
  void databaseRejectsASecondEntryForTheSameTransferAndAccount() {
    Account source =
        accountRepository.save(
            new Account("REF-S", "Source", AccountType.CUSTOMER, "USD", AccountStatus.ACTIVE));
    Account target =
        accountRepository.save(
            new Account("REF-T", "Target", AccountType.CUSTOMER, "USD", AccountStatus.ACTIVE));
    Transfer transfer =
  ...
  void databaseRejectsADebitRecordedAsAPositiveAmount() {
    Account source =
        accountRepository.save(
            new Account("REF-S2", "Source", AccountType.CUSTOMER, "USD", AccountStatus.ACTIVE));
    Account target =
        accountRepository.save(
            new Account("REF-T2", "Target", AccountType.CUSTOMER, "USD", AccountStatus.ACTIVE));
    Transfer transfer =
        transferRepository.save(
            new Transfer(
                source.getId(),
  ...
  void savesAndReloadsALedgerEntry() {
    Account source =
        accountRepository.save(
            new Account("REF-S3", "Source", AccountType.CUSTOMER, "USD", AccountStatus.ACTIVE));
    Account target =
        accountRepository.save(
            new Account("REF-T3", "Target", AccountType.CUSTOMER, "USD", AccountStatus.ACTIVE));
    Transfer transfer =
        transferRepository.save(
            new Transfer(
                source.getId(),
  ...
  void transferRepositoryExposesNoUpdateOrDeleteMethod() {
    var methodNames =
        Arrays.stream(TransferRepository.class.getMethods()).map(Method::getName).toList();
